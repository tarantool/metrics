...
%dir %{luapkgdir}/metrics/default_metrics/cartridge
     %{luapkgdir}/metrics/default_metrics/cartridge/init.lua
     %{luapkgdir}/metrics/default_metrics/cartridge/issues.lua
