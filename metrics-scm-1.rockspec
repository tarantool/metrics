...
build = {
    ...
    modules = {
        ...
        ['metrics.default_metrics.cartridge']            = 'metrics/default_metrics/cartridge/init.lua',
        ['metrics.default_metrics.cartridge.issues']     = 'metrics/default_metrics/cartridge/issues.lua',
