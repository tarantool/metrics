...
- set custom handlers with `set_custom_handlers` function [#120](https://github.com/tarantool/metrics/issues/120),
  [#242](https://github.com/tarantool/metrics/issues/242)
